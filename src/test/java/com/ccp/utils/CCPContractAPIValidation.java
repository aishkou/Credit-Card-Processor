...
public class CCPContractAPIValidation {
     ...
     */
    private static final String SWAGGER_JSON_URL = "/CreditCardProcessor/Credit-Card-Processor/src/main/resources/swagger_ccp.yaml";
    ...
    public void testGetValidContract() {
        given()
                ...
                .when()
                .get("http://localhost:8080/ccp/getAll")
                .then()
                .assertThat()
                .statusCode(200);
    }
